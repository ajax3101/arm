...
uses DataModuleUnit, TarifUnit, StudentUnit, Unit2, UserUnit;
...
begin
 ...
 XLApp.Workbooks[1].WorkSheets[1].Name:='АРМ-Технический персонал';
 Colum:=XLApp.Workbooks[1].WorkSheets['АРМ-Технический персонал'].Columns;
 ...
 Colum:=XLApp.Workbooks[1].WorkSheets['АРМ-Технический персонал'].Rows;
 Colum.Rows[2].Font.Bold:=true;
 Colum.Rows[1].Font.Bold:=true;
 Colum.Rows[1].Font.Color:=clBlack;
 Colum.Rows[1].Font.Size:=14;

 Sheet:=XLApp.Workbooks[1].WorkSheets['АРМ-Технический персонал'];
 Sheet.Cells[1,2]:='Key1';
